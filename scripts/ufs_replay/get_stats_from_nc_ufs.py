...
variables= {
    ...
    'prescribed': ['toa_incident_solar_radiation', 'sea_surface_temperature'],
}

levels = [1000, 925, 850, 700, 600, 500, 400, 300, 250, 200, 150, 100, 50]

ds_means = xr.open_dataset('mean_by_level_ufs_1994-2016.nc')
ds_stds = xr.open_dataset('std_by_level_ufs_1994-2016.nc')
...
np.save('stats/global_mean_ufs_1994-2016_chn85.npy', mean_exp)
np.save('stats/global_std_ufs_1994-2016_chn85.npy', std_exp)
